...
public interface EnrollmentRepository extends CrudRepository<Enrollment, Integer> {
    ...
    @Query("select e from Enrollment e where e.section.sectionNo=:sectionNo order by e.student.id")
    List<Enrollment> findEnrollmentsBySectionNoOrderByStudentId(int sectionNo);
}
